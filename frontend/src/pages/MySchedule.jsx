...
export default function MySchedule() {
  ...
  if (user.role !== 'Barber') {
    ...
    // (see App.jsx's roles={['Barber', 'Admin']}) requires this route to
    // accept Admin, but there is no barber to show a schedule for yet --
    // this placeholder is the deliberate, temporary stand-in until that
    // story lands.
    return (
