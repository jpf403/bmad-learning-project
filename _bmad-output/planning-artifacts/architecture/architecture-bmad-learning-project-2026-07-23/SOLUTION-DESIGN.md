...
- **Refresh-token rotation and reuse-detection** (Section 3.5) — an accepted trade-off, not a gap. Revisit if the current 21-day stolen-cookie exposure window ever stops being an acceptable risk for the project's actual threat model.
